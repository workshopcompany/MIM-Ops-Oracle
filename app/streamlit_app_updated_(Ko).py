"""
변경사항 요약 (solver_updated.py 연동):
  ★ wall_friction_k 슬라이더 추가 (0.0~10.0, 기본 3.0)
  ★ flow_decay 슬라이더 추가 (0.0~2.0, 기본 0.5)
  ★ session_state 초기화에 두 파라미터 추가
  ★ submit_simulation params 딕셔너리에 두 파라미터 추가
  ★ submit_simulation 함수 data 전송 부분에 두 파라미터 추가
"""
